...
export const BotWindow = forwardRef<HTMLDivElement, Props>(
  (
    ...
    console.log(errors)
    return (
      <div className="h-[670px] w-[400px] flex flex-col bg-white rounded-xl mr-[80px] border-[1px] overflow-hidden">
        ...
        >
          ...
          <TabsContent value="helpdesk">
            <div className="h-[385px] overflow-y-auto overflow-x-hidden p-4 flex flex-col gap-4">
              <div>
        ...
        <div className="flex justify-center ">
          <p className="text-gray-400 text-xs">Powered By Piyush Sharma</p>
        </div>
      </div>
    )
  }
